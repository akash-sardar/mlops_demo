...
class ModelTrainerConfig:
    ...
    model_trainer_trained_model_dir: str = os.path.join(model_trainer_dir, MODEL_TRAINER_TRAINED_MODEL_DIR_NAME)
    trained_model_file_path: str = os.path.join(model_trainer_trained_model_dir, MODEL_TRAINER_TRAINED_MODEL_NAME)
