...
from project_01.utils.main_utils import read_yaml_file, write_yaml_file
from project_01.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact
from project_01.entity.config_entity import DataValidationConfig
from project_01.constants import SCHEMA_FILE_PATH_URL
...
class DataValidation:
    ...
    def detect_dataset_drift(self, reference_df: DataFrame, current_df: DataFrame, ) -> bool:
        ...
        try:
            ...
            write_yaml_file(file_path=self.data_validation_config.data_validation_drift_report_dir, content=json_report)
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            data_validation_artifact = DataValidationArtifact(
                ...
                data_validation_drift_report_dir=self.data_validation_config.data_validation_drift_report_dir
            )
